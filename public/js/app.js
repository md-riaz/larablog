...
/***/ "./resources/js/OwlCarousel2_2.3.4.js":
/*!********************************************!*\
  !*** ./resources/js/OwlCarousel2_2.3.4.js ***!
  \********************************************/
/*! no static exports found */
...
__webpack_require__(/*! ./lazysizes.min */ "./resources/js/lazysizes.min.js");

__webpack_require__(/*! ./OwlCarousel2_2.3.4 */ "./resources/js/OwlCarousel2_2.3.4.js");
...
$(document).ready(function () {
  ...
  var feature_slider = $(".feature-post-slider");
  ...
  $(document).on("click", "#delete", function (e) {
    ...
    swalWithBootstrapButtons.fire({
      ...
      if (result.value) {
        ...
        $action = $(_this).data("action"); //  Set delete form action attribute to that url

        $("#deleteForm").attr("action", $action); // Submit the form
...
https://prismjs.com/download.html#themes=prism-tomorrow&languages=markup+css+clike+javascript+diff+java+javadoclike+json+markdown+markup-templating+php+phpdoc+php-extras+python+sass+scss+sql&plugins=line-highlight+line-numbers+file-highlight+show-language+jsonp-highlight+highlight-keywords+data-uri-highlight+toolbar+download-button+match-braces+diff-highlight */
  ...
  if ("undefined" != typeof self && self.Prism && self.document) if (Prism.plugins.toolbar) {
    ...
    Prism.plugins.toolbar.registerButton("show-language", function (e) {
      ...
      if (a && /pre/i.test(a.nodeName)) {
        var t,
            s = a.getAttribute("data-language") || r[e.language] || ((t = e.language) ? (t.substring(0, 1).toUpperCase() + t.substring(1)).replace(/s(?=cript)/, "S") : t);
...
!function (t, e) {
  ...
  var lt,
    ...
    return !(!t || !(t.offsetWidth || t.offsetHeight || t.getClientRects().length));
      ...
      gt = function gt(t) {
    var e,
        n = !!(e = K()) && (e.parentNode.removeChild(e), pt([document.documentElement, document.body], [z["no-backdrop"], z["toast-shown"], z["has-column"]]), !0);
    if (at()) v("SweetAlert2 requires document to initialize");else {
  ...
  function Ct(t, e) {
    ...
    if (n) {
      var o, i, r, a;
      o = n, "string" == typeof (i = e.backdrop) ? o.style.background = i : i || dt([document.documentElement, document.body], z["no-backdrop"]), !e.backdrop && e.allowOutsideClick && N('"allowOutsideClick" parameter requires `backdrop` parameter to be set to `true`'), r = n, (a = e.position) in z ? dt(r, z[a]) : (N('The "position" parameter is not valid, defaulting to "center"'), dt(r, z.center)), function (t, e) {
  ...
  function qt(t, s) {
    ...
    l >= s.progressSteps.length && N("Invalid currentProgressStep parameter, it should be less than progressSteps.length (currentProgressStep like JS arrays starts from 0)"), s.progressSteps.forEach(function (t, e) {
      var n,
          ...
          i,
          r,
          a = (n = t, o = document.createElement("li"), dt(o, z["progress-step"]), V(o, n), o);
  ...
  function It(t, e) {
    var n,
        ...
        r,
        a = T();
    H(a, e, "header"), qt(0, e), function (t, e) {
      var n = xt.innerParams.get(t);
      if (n && e.icon === n.icon && C()) H(C(), e, "icon");else if (Vt(), e.icon) if (-1 !== Object.keys(W).indexOf(e.icon)) {
  ...
  function se(t) {
    ...
    if (e) {
      ...
      if (n && !R(e, n.hideClass.popup)) {
        ...
        var i = K();
        pt(i, n.showClass.backdrop), dt(i, n.hideClass.backdrop), function (t, e, n) {
          var o = K(),
              i = yt && it(e),
              r = n.onClose,
              a = n.onAfterClose;
  ...
  var Xe,
    ...
    _main: function _main(t) {
      !function (t) {
        for (var e in t) {
          Kt(i = e) || N('Unknown parameter "'.concat(i, '"')), t.toast && (o = e, -1 !== Xt.indexOf(o) && N('The parameter "'.concat(o, '" is incompatible with toasts'))), Yt(n = e) && g(n, Yt(n));
        }
      ...
      return jt(this, e), xt.innerParams.set(this, e), function (n, o, i) {
        return new Promise(function (t) {
          var e = function t(e) {
            n.closePopup({
              dismiss: e
...
__webpack_require__(/*! D:\laragon\www\modernblog\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! D:\laragon\www\modernblog\resources\sass\app.scss */"./resources/sass/app.scss");
